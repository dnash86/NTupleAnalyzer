...
Uncertainties = open('Uncertainties_ele.tex','w') 
...
for x in List:
    ...
    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $1}'"
    print String
    Data=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    MC=float(os.popen(String).readline().replace('\n',''))
    
    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $2}'"
    tt=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(int(y+13)) +") {print $1}'"
    ...
    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $3}'"
    z=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(int(y+13)) +") {print $2}'"
    ...
    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    sig=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 26 NoSystematics IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(int(y+13)) +") {print $3}'"
    ...
    #String = "grep -A 26 EleScaleDown IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    #MC_EleScaleDown=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 EleScaleUp IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    #MC_EleScaleUp=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 JetScaleDown IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    #MC_JetScaleDown=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 JetScaleUp IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    #MC_JetScaleUp=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 JetSmear IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    #MC_JetSmear=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 EleSmear IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    #MC_EleSmear=float(os.popen(String).readline().replace('\n',''))

    ########
    #String = "grep -A 26 EleScaleDown IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    #sig_EleScaleDown=float(os.popen(String).readline().replace('\n',''))
 
    #String = "grep -A 26 EleScaleUp IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    #sig_EleScaleUp=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 JetScaleDown IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    #sig_JetScaleDown=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 JetScaleUp IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    #sig_JetScaleUp=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 JetSmear IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    #sig_JetSmear=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 26 EleSmear IntegralGetterOutput_ele_3.txt | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
