...
os.system("cp LimitPlots/TEMPLATE.C LimitPlots/CurrentLimitsNew_mu.C")
os.system("sed -i -e 's/CurrentLimits/CurrentLimitsNew_ele/g' LimitPlots/CurrentLimitsNew_mu.C")
...
for x in Values:
    ...
    os.system("sed -i -e 's/Obs" + str(x) + "/" + str(ObsLim*CS) + "/g' LimitPlots/CurrentLimitsNew_mu.C")
    os.system("sed -i -e 's/MinTwo" + str(x) + "/" + str(-MinusTwo*CS+Center*CS) + "/g' LimitPlots/CurrentLimitsNew_mu.C")
    os.system("sed -i -e 's/MinOne" + str(x) + "/" + str(-MinusOne*CS+Center*CS) + "/g' LimitPlots/CurrentLimitsNew_mu.C")
    os.system("sed -i -e 's/Center" + str(x) + "/" + str(Center*CS) + "/g' LimitPlots/CurrentLimitsNew_mu.C")
    os.system("sed -i -e 's/PlusOne" + str(x) + "/" + str(PlusOne*CS-Center*CS) + "/g' LimitPlots/CurrentLimitsNew_mu.C")
    os.system("sed -i -e 's/PlusTwo" + str(x) + "/" + str(PlusTwo*CS-Center*CS) + "/g' LimitPlots/CurrentLimitsNew_mu.C")
    os.system("sed -i -e 's/ThCS" + str(x) + "/" + str(CS) + "/g' LimitPlots/CurrentLimitsNew_mu.C")
