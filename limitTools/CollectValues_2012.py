...
#File = os.popen('cat CMU_Template.cfg_JustMuon').readlines()


#File = os.popen('cat CMU_Template_JustMuon.cfg').readlines()
File = os.popen('cat CMU_Template_JustMuon_Rescaled.cfg').readlines()


#InputFile = "2012MuonOutput.txt"
#InputFile = "FullOutput.txt"
#InputFile = "MuSSBLog.txt"
#InputFile = "MuPunziLog.txt"
#InputFile = "MuSSB_ptchoice.txt"
#InputFile = "MuPunzi_ptchoice.txt"
#InputFile = "FixedPreselMuOutput.txt"
#InputFile = "FixedPreselMuOutput_HighMCut.txt"
#InputFile = "TryOtherOptNumbers.txt"
#InputFile = "TryOtherOptNumbers_jetcuthigh.txt"
#InputFile = 'MuonOutputFixed.txt'
#InputFile = '~/CMSSW_5_0_0/src/NTupleAnalyzer/PlotMacros/MuonRecentOutput_Full.txt'
#InputFile = 'RedoPU.txt'
#InputFile = 'CheckNewZRescale.txt'
#InputFile = 'FirstOut.txt'
#InputFile = 'EleNumbers_July16.txt'
#InputFile = 'MuonNumbers_Aug7.txt'
#InputFile = 'MuonNumbers_125GeVCut_Aug8.txt'
#InputFile = 'MuonLog_newQCD3.txt'
#InputFile = 'MuonLog_newQCD4.txt'

#InputFile = 'MuonLog_Sep8.txt'
#InputFile = 'FiducialMuonsSep25.csv'
#InputFile = 'FiducialMuons0p8.csv'
#InputFile = 'MuonLog_TestNorm.txt'


#InputFile = 'TestMuonNorm2.txt'
#InputFile = 'FiducialMuonsDilepton.csv'
#InputFile = 'FiducialMuons0p66.csv'
#InputFile = 'FiducialMuons0p75.csv'
InputFile = 'FiducialMuons0p75_ChangedFirstPoint_Rescaled.csv'

#InputFile = 'FiducialMuons0p75_Rescaled.csv'


#EntriesFile='CentralValuesMuonForEntries_Entries.txt'

#EntriesFile='CentralValues_Muon_newQCD_Entries.txt'
#EntriesFile='CentralValues_Muon_Fiducial_Entries.csv'
#EntriesFile='CentralValues_Muon_Fiducial_Entries0p8.csv'
#EntriesFile = 'CentralValues_Muon_TestNorm_Entries.txt'


#EntriesFile='TestMuonNorm2_Entries.txt'
#EntriesFile = 'FiducialMuonsDilepton_Entries.csv'
#EntriesFile = 'FiducialMuons0p66_Entries.csv'
#EntriesFile = 'FiducialMuons0p75_Entries.csv'

EntriesFile = 'FiducialMuons0p75_ChangedFirstPoint_Entries.csv'


RescaleErrorsFile = 'CentralValues_Muon_RescaleError.txt'

Sigs=open('Significances_mumu.txt','w')
...
additionalttuncertainty = 0.04
ttratioerr = math.sqrt(ttratioerr**2+additionalttuncertainty**2)
...
def SetValues(y):
    ...
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $1}'"
    print String
    Data=float(os.popen(String).readline().replace('\n',''))

    #String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    #MC=float(os.popen(String).readline().replace('\n',''))
    
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $2}'"
    tt=float(os.popen(String).readline().replace('\n',''))
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(int(y+16)) +") {print $2}'"
    ...
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $3}'"
    z=float(os.popen(String).readline().replace('\n',''))
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(int(y+16)) +") {print $3}'"
    ...
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(int(y+16)) +") {print $4}'"
    ...
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    singtop=float(os.popen(String).readline().replace('\n',''))
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(int(y+16)) +") {print $5}'"
    ...
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $6}'"
    wjets=float(os.popen(String).readline().replace('\n',''))
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(int(y+16)) +") {print $6}'"
    ...
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $7}'"
    qcd=float(os.popen(String).readline().replace('\n',''))
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(int(y+16)) +") {print $7}'"
    ...
    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 NoSystematics " + InputFile + " | gawk -F ',' '(NR==" + str(int(y+16)) +") {print $8}'"
    ...
    MC = qcd+wjets+singtop+diboson+z+tt
    ...
    String = "grep -A 32 ZScaleUp " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $3}'"
    MC_ZScaleUp=float(os.popen(String).readline().replace('\n',''))


    String = "grep -A 32 ZScaleDown " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $3}'"
    ...
    ########
    String = "grep -A 32 MuScaleDown " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig_MuScaleDown=float(os.popen(String).readline().replace('\n',''))
 
    String = "grep -A 32 MuScaleUp " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig_MuScaleUp=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 JetScaleDown " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig_JetScaleDown=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 JetScaleUp " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig_JetScaleUp=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 JetSmear " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig_JetSmear=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 MuSmear " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig_MuSmear=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 PU_up " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    sig_PUup=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 PU_down " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $8}'"
    ...
    Z_pdfs=GetPDFError('Mu_PDF_Z.txt',y)
    ...
    W_pdfs=GetPDFError('Mu_PDF_W.txt',y)
    ...
    SingleTop_pdfs=GetPDFError('Mu_PDF_SingleTop.txt',y)
    ...
    DiBoson_pdfs=GetPDFError('Mu_PDF_DiBoson.txt',y)
    ...
    sig_pdfs=GetPDFError('Mu_SignalAcceptance_PDF.txt',y)
...
def GetTotalMC(UncertaintyType,y):
    String = "grep -A 32 "+UncertaintyType+" " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $2}'"
    TotalMC=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 "+UncertaintyType+" " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $3}'"
    TotalMC+=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 "+UncertaintyType+" " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $4}'"
    TotalMC+=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 "+UncertaintyType+" " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $5}'"
    TotalMC+=float(os.popen(String).readline().replace('\n',''))

    String = "grep -A 32 "+UncertaintyType+" " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $6}'"
    TotalMC+=float(os.popen(String).readline().replace('\n',''))
    
    String = "grep -A 32 "+UncertaintyType+" " + InputFile + " | gawk -F ',' '(NR==" + str(y) +") {print $7}'"
    TotalMC+=float(os.popen(String).readline().replace('\n',''))
...
def MakeConfigFile():
    ...
    for Z in range(len(File)): 
        ...
        #NewFile[Z] = NewFile[Z].replace('MSTWdown_Z',str(MSTWdown_Z))
        #NewFile[Z] = NewFile[Z].replace('MSTWup_Z',str(MSTWup_Z))
        #NewFile[Z] = NewFile[Z].replace('CTEQdown_Z',str(CTEQdown_Z))
        #NewFile[Z] = NewFile[Z].replace('CTEQup_Z',str(CTEQup_Z))
...
def SaveValuesForCards():
    ...
    ZShapeImpact_MC = max(ZMatchImpact_MC,ZScaleImpact_MC)*(Z/MC)
...
def SaveValuesForExample():
    ...
    #ZShapeImpact_MC300 = max(ZMatchImpact_MC300,ZScaleImpact_MC300)*(Z/MC)
    ZShapeImpact_MC300 = max(ZMatchImpact_MC300,ZScaleImpact_MC300)#*(Z/MC)
    ...
    print "QCD IMPACT IS: "+str(QCDNormImpact_MC300)
    print QCD
    print MC
    print qcdratioerr
    ...
    print "TotalUncertainty_MC = "+str(TotalUncertainty_MC)
    #print "Check = "+str(( (((trigerr-1)**2+(recoerr-1)**2+(lumierr-1)**2+znormerr**2+qcdratioerr**2+ttratioerr**2+TotalUncertainty_MC)**(0.5))*100))
    #print "Check = "+str( (((trigerr-1)**2+(recoerr-1)**2+(lumierr-1)**2+znormerr**2+qcdratioerr**2+ttratioerr**2+TotalUncertainty_MC)**(0.5)))
...
List = [y+2 for y in range(16)] #To start with a value of 2, for gawk
...
Uncertainties.write("\\hline\n")
Uncertainties.write("\\textbf{Muon Energy Scale}  & \\textbf{"+str("%.2f" % MuScaleImpact_sig300)+"} & \\textbf{"+str("%.2f" % MuScaleImpact_MC300)+"}\\\\\n")
Uncertainties.write("\\hline\n")
Uncertainties.write("\\textbf{Muon Energy Resolution}  & \\textbf{"+str("%.2f" % MuSmearImpact_sig300)+"} & \\textbf{"+str("%.2f" % MuSmearImpact_MC300)+"}\\\\\n")
Uncertainties.write("\\hline\n")
Uncertainties.write("\\textbf{PileUp}  & \\textbf{"+str("%.2f" % PUImpact_sig300)+"} & \\textbf{"+str("%.2f" % PUImpact_MC300)+"}\\\\\n")
Uncertainties.write("\\hline\n")
Uncertainties.write("\\textbf{Muon ID/iso}  & \\textbf{"+str("%.2f" % IDImpact_sig300)+"} & \\textbf{"+str("%.2f" % IDImpact_MC300)+"}\\\\\n")
Uncertainties.write("\\hline\n")
...
#Uncertainties.write("\\textbf{CTEQ PDF Weight}  & \\textbf{PENDING} & \\textbf{"+str("%.2f" % ZCTEQImpact)+"}\\\\\n")
#Uncertainties.write("\\hline\n")
#Uncertainties.write("\\textbf{MSTW PDF Weight}  & \\textbf{PENDING} & \\textbf{"+str("%.2f" % ZMSTWImpact)+"}\\\\\n")
#Uncertainties.write("\\hline\n")
