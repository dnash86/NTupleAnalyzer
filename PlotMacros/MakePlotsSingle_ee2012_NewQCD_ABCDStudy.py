...
#Files_qcd = '/store/user/dnash/LQAnalyzerOutput2/NTupleAnalyzer_V00_02_06_David_2012_ABCDStudy_ABCDStudy_2014_08_04_21_36_04/SummaryFiles'

#Files_qcd = '/store/user/dnash/LQAnalyzerOutput2/NTupleAnalyzer_V00_02_06_David_2012_ABCDStudy_ABCDStudy_InvertedIso_2014_08_05_21_05_52/SummaryFiles'

Files_qcd = '/store/user/dnash/LQAnalyzerOutput2/NTupleAnalyzer_V00_02_06_David_2012_ABCDStudy_ABCDStudy_InvertedIso_TrkIsoToo_2014_08_07_12_57_58/SummaryFiles'
...
def DrawHisto(JustIntegrate,lq_choice, selection, emuselection, qcdselection, use_emu, drawSub, binning, variable, variable_emu, variable_qcd, xlabel,zscale,ttscaler,tag):
    ...
    h_QCD_A=MakeHisto('h_QCD_A','',DoublePhotonData,variable,binning,selection+Filters+Trigger,Style_A,Label)
    Data_A=h_QCD_A.Integral()
    h_qcd_A_WJets=MakeHisto('h_qcd_A_WJets','W+Jets',WJetsJBin,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_A,Label)
    h_qcd_A_DiBoson=MakeHisto('h_qcd_A_DiBoson','DiBoson',DiBoson,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_A,Label)
    h_qcd_A_ZJets=MakeHisto('h_qcd_A_ZJets','Z+Jets',ZJetsJBin,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_A,Label)
    h_qcd_A_SingleTop=MakeHisto('h_qcd_A_SingleTop','SingleTop',SingleTop,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_A,Label)
    h_qcd_A_GJets=MakeHisto('h_qcd_A_Gjets','#gamma+Jets',Gjets,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_A,Label)
    h_qcd_A_TTBar=MakeHisto('h_qcd_A_TTBar','t#bar{t}',TTBarDBin,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_A,Label)
    ...
    Test=MakeHisto('Test','Data',qcd_DoublePhotonData,variable,binning,"1.0"+Filters+Trigger,Style_nonA,Label)
    print "Testing, just trigger and filters: "+ str(Test.Integral())

    h_QCD_B=MakeHisto('h_QCD_B','Data',qcd_DoublePhotonData,variable,binning,selection+Filters+Trigger,Style_nonA,Label)
    Data_B=h_QCD_B.Integral()
    h_qcd_B_WJets=MakeHisto('h_qcd_B_WJets','W+Jets',qcd_WJetsJBin,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_B_DiBoson=MakeHisto('h_qcd_B_DiBoson','DiBoson',qcd_DiBoson,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_B_ZJets=MakeHisto('h_qcd_B_ZJets','Z+Jets',qcd_ZJetsJBin,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_B_SingleTop=MakeHisto('h_qcd_B_SingleTop','SingleTop',qcd_SingleTop,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_B_GJets=MakeHisto('h_qcd_B_Gjets','#gamma+Jets',qcd_Gjets,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_B_TTBar=MakeHisto('h_qcd_B_TTBar','t#bar{t}',qcd_TTBarDBin,variable,binning,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    ...
    h_QCD_C=MakeHisto('h_QCD_C','Data',DoublePhotonData,variable,binning,qcdselection+Filters+Trigger,Style_nonA,Label)
    Data_C=h_QCD_C.Integral()
    h_qcd_C_WJets=MakeHisto('h_qcd_C_WJets','W+Jets',WJetsJBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_C_DiBoson=MakeHisto('h_qcd_C_DiBoson','DiBoson',DiBoson,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_C_ZJets=MakeHisto('h_qcd_C_ZJets','Z+Jets',ZJetsJBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_C_SingleTop=MakeHisto('h_qcd_C_SingleTop','SingleTop',SingleTop,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_C_GJets=MakeHisto('h_qcd_C_Gjets','#gamma+Jets',Gjets,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_C_TTBar=MakeHisto('h_qcd_C_TTBar','t#bar{t}',TTBarDBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    ...
    h_QCD_D=MakeHisto('h_QCD_D','Data',qcd_DoublePhotonData,variable,binning,qcdselection+Filters+Trigger,Style_nonA,Label)
    Data_D=h_QCD_D.Integral()
    h_qcd_D_WJets=MakeHisto('h_qcd_D_WJets','W+Jets',qcd_WJetsJBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_D_DiBoson=MakeHisto('h_qcd_D_DiBoson','DiBoson',qcd_DiBoson,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_D_ZJets=MakeHisto('h_qcd_D_ZJets','Z+Jets',qcd_ZJetsJBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_D_SingleTop=MakeHisto('h_qcd_D_SingleTop','SingleTop',qcd_SingleTop,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_D_GJets=MakeHisto('h_qcd_D_Gjets','#gamma+Jets',qcd_Gjets,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    h_qcd_D_TTBar=MakeHisto('h_qcd_D_TTBar','t#bar{t}',qcd_TTBarDBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,Style_nonA,Label)
    ...
    selections=[selection+Filters+Trigger,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters,selection+CorrectLumiAndPU+DoubleENonEmulatedTrigger+Filters]
    ...
    h_QCD_AplusB=MakeHisto('h_QCD_AplusB','Data',DoublePhotonData,variable,binning,selection+Filters+Trigger,Style_A,Label)
    ...
    h_QCD_AplusC=MakeHisto('h_QCD_AplusC','Data',DoublePhotonData,variable,binning,selection+Filters+Trigger,Style_A,Label)
    ...
    h_QCD_CplusD=MakeHisto('h_QCD_CplusD','Data',DoublePhotonData,variable,binning,qcdselection+Filters+Trigger,Style_nonA,Label)
    ...
    h_QCD_BplusD=MakeHisto('h_QCD_BplusD','Data',qcd_DoublePhotonData,variable,binning,selection+Filters+Trigger,Style_nonA,Label)
