...
CentralFile='CentralValues_Muon_newQCD.txt'
...
def main():
    ...
    nnpdfvalues=collect('NNPDF',MainDir,[2])
    cteqvalues=collect('CTEQ',MainDir,[2])
    mstwvalues=collect('MSTW',MainDir,[2])
    ...
    DoBackgrounds([2],'Mu_PDF_Z.txt')
    DoBackgrounds([3],'Mu_PDF_DiBoson.txt')
    DoBackgrounds([4],'Mu_PDF_SingleTop.txt')
    DoBackgrounds([5],'Mu_PDF_W.txt')
    #return
    ...
    PreselDir='ParallelFilesPresel_mumu'
    ...
    logfile = open('Mu_SignalNormalization_PDF.txt','w')
    ...
    logfile = open('Mu_SignalAcceptance_PDF.txt','w')
