...
def DoIntegrals(JustIntegrate,lq_choice, selection, emuselection, qcdselection, use_emu, drawSub, variable, variable_emu, variable_qcd, xlabel,zscale,ttscaler):
    SetStyle()
    channel = "ee"
    Luminosity = "19600"
    binning = [5,0,3000]
...
def integrate():
    ...
    Selection+= "*WEIGHTS_NNPDF"

    DoIntegrals(JustIntegrate,lq_choice, Selection, Selection_emu, Selection_qcd, use_emu, drawSub,  "MET_pf", "MET_pf", "MET_pf", "MET_pf" , znorm, ttscaler)   
