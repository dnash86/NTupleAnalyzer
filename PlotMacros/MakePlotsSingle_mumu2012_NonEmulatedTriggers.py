...
def plot():
    ...
    if znorm==1.0:
        ...
        Selection_qcd = '((Pt_muon1>45)*(Pt_muon2>45)*(Pt_pfjet1>45)*(deltaR_muon1muon2>0.3)*((abs(Eta_muon1)<2.1)*(abs(Eta_muon2)<2.1))*(M_muon1muon2>80)*(M_muon1muon2<100))*(ST_pf_mumu_single> 250)*((Charge_muon1*Charge_muon2)==1)'
