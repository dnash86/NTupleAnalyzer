...
def GetIntegralsAndErrors(JustIntegrate,lq_choice, selection, emuselection, qcdselection, use_emu, drawSub, binning, variable, variable_emu, variable_qcd, xlabel,zscale,ttscaler,tag):
    ...
    signalselections = [selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice]

    SignalValues=IntegralAndError(signaltrees,signalweights,signalselections)

    DataValues=IntegralAndError([DoublePhotonData],[1],[selection+Filters])

    WJetsValues=IntegralAndError([WJetsJBin],[1],[selection+CorrectLumiAndPU+DoubleETrigger+Filters])
    DiBosonValues=IntegralAndError([DiBoson],[1],[selection+CorrectLumiAndPU+DoubleETrigger+Filters])
    SingleTopValues=IntegralAndError([SingleTop],[1],[selection+CorrectLumiAndPU+DoubleETrigger+Filters])
    ZJetsValues=IntegralAndError([ZJetsJBin],[1],[selection+'*('+str(zscale)+')'+CorrectLumiAndPU+DoubleETrigger+Filters])

    print "On TTBar now"
    if use_emu:
        ttbartrees=[emu_SingleMuData,emu_WJetsJBin,emu_DiBoson,emu_ZJetsJBin,emu_SingleTop]
        ttbarweights=[1,-1,-1,-1,-1]
        ttbarselections=[emuselection+'*('+str(ttscaler)+')'+Filters,emuselection+'*('+str(ttscaler)+')'+CorrectLumiAndPU+SingleMuTrigger+Filters,emuselection+'*('+str(ttscaler)+')'+CorrectLumiAndPU+SingleMuTrigger+Filters,emuselection+'*('+str(ttscaler)+')'+CorrectLumiAndPU+SingleMuTrigger+Filters,emuselection+'*('+str(ttscaler)+')'+CorrectLumiAndPU+SingleMuTrigger+Filters]

        TTBarValues=IntegralAndError(ttbartrees,ttbarweights,ttbarselections)

    else:
        TTBarValues=IntegralAndError([TTBarDBin],[1],[selection+CorrectLumiAndPU+DoubleETrigger+Filters])

   
    GJetsValues=IntegralAndError([Gjets],[1],[selection+CorrectLumiAndPU+DoubleETrigger+Filters])

    if (zscale != 1.00):
        if True:
            qcdtrees=[DoublePhotonData,WJetsJBin,DiBoson,ZJetsJBin,SingleTop,Gjets,TTBarDBin]
            qcdweights=[1,-1,-1,-1,-1,-1,-1]
            qcdselections=[qcdselection+Filters,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters]
...
def DrawHisto(JustIntegrate,lq_choice, selection, emuselection, qcdselection, use_emu, drawSub, binning, variable, variable_emu, variable_qcd, xlabel,zscale,ttscaler,tag):
    ...
    #print selection
    h_Signal=MakeHisto('h_Signal','LQToUE_Single_L_0p2',LQToUE_Single_L_0p2,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,SignalStyle,Label)
    h_LQToUE_Single_L0p4=MakeHisto('h_LQToUE_Single_L0p4','LQToUE_Single_L0p4',LQToUE_Single_L_0p4,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,SignalStyle,Label)
    h_Signal.Add(h_LQToUE_Single_L0p4)
    h_LQToUE_Single_L0p6=MakeHisto('h_LQToUE_Single_L0p6','LQToUE_Single_L0p6',LQToUE_Single_L_0p6,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,SignalStyle,Label)
    h_Signal.Add(h_LQToUE_Single_L0p6)
    h_LQToUE_Single_L0p8=MakeHisto('h_LQToUE_Single_L0p8','LQToUE_Single_L0p8',LQToUE_Single_L_0p8,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,SignalStyle,Label)
    h_Signal.Add(h_LQToUE_Single_L0p8)
    h_LQToUE_Single_L1p0=MakeHisto('h_LQToUE_Single_L1p0','LQToUE_Single_L1p0',LQToUE_Single_L_1p0,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters+lq_choice,SignalStyle,Label)
    ...
    h_WJets=MakeHisto('h_WJets','W+Jets',WJetsJBin,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters,WStackStyle,Label)
    h_DiBoson=MakeHisto('h_DiBoson','DiBoson',DiBoson,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters,DiBosonStackStyle,Label)
    h_SingleTop=MakeHisto('h_SingleTop','SingleTop',SingleTop,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters,StopStackStyle,Label)    

    h_ZJets=MakeHisto('h_ZJets','Z+Jets',ZJetsJBin,variable,binning,selection+'*('+str(zscale)+')'+CorrectLumiAndPU+DoubleETrigger+Filters,ZStackStyle,Label)
    ...
    if use_emu:
        ...
        h_emu_WJets=MakeHisto('h_emu_WJets','W+Jets',emu_WJetsJBin,variable_emu,binning,emuselection+CorrectLumiAndPU+SingleMuTrigger+Filters,TTStackStyle,Label)
        h_emu_DiBoson=MakeHisto('h_emu_DiBoson','DiBoson',emu_DiBoson,variable_emu,binning,emuselection+CorrectLumiAndPU+SingleMuTrigger+Filters,TTStackStyle,Label)
        h_emu_ZJets=MakeHisto('h_emu_ZJets','Z+Jets',emu_ZJetsJBin,variable_emu,binning,emuselection+CorrectLumiAndPU+SingleMuTrigger+Filters,TTStackStyle,Label)
        h_emu_SingleTop=MakeHisto('h_emu_SingleTop','SingleTop',emu_SingleTop,variable_emu,binning,emuselection+CorrectLumiAndPU+SingleMuTrigger+Filters,TTStackStyle,Label)
        ...
        h_TTBar=MakeHisto('h_TTBar','t#bar{t}',TTBarDBin,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters,TTStackStyle,Label)

    #print "Made the ttbar plots"

    #If the channel is ee, include G Jets background and the QCD fake rate sample
    h_GJets=MakeHisto('h_GJets','#gamma+Jets',Gjets,variable,binning,selection+CorrectLumiAndPU+DoubleETrigger+Filters,GJetsStackStyle,Label)
    if (zscale != 1.00):
        ...
        if True:
            ...
            h_qcd_WJets=MakeHisto('h_qcd_WJets','W+Jets',WJetsJBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,WStackStyle,Label)
            h_qcd_DiBoson=MakeHisto('h_qcd_DiBoson','DiBoson',DiBoson,variable,binning,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,DiBosonStackStyle,Label)
            h_qcd_ZJets=MakeHisto('h_qcd_ZJets','Z+Jets',ZJetsJBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,ZStackStyle,Label)
            h_qcd_SingleTop=MakeHisto('h_qcd_SingleTop','SingleTop',SingleTop,variable,binning,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,StopStackStyle,Label)
            h_qcd_GJets=MakeHisto('h_qcd_Gjets','#gamma+Jets',Gjets,variable,binning,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,GJetsStackStyle,Label)
            h_qcd_TTBar=MakeHisto('h_qcd_TTBar','t#bar{t}',TTBarDBin,variable,binning,qcdselection+CorrectLumiAndPU+DoubleETrigger+Filters,TTStackStyle,Label)
...
def plot():
    ...
    drawSub = True
    use_emu = True
    ttscaler = 0.479080479194  #0.488708924407 #0.490929901239
    znorm = 0.985767217704   #+/-0.00708206294045
    #znorm = 0.9857
    #znorm = 0.96072
    #znorm = 1.0001
    #znorm = 1.0
