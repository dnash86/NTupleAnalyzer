...
def plot():
    ...
    Region1 = "( (Pt_QCDele1 < 208.2) *( 1.294e-02  - 3.900e-5 * Pt_QCDele1 ))+"
    Region1 = Region1 + "( (Pt_QCDele1>= 208.2) *( 4.928e-3 - 5.071e-7  * Pt_QCDele1 ))"

    Region2 = "( (Pt_QCDele1 < 91.3) *(5.918e-2 - 2.964e-4  *  * Pt_QCDele1 ))+"
    Region2 = Region2 + "( (Pt_QCDele1>= 91.3) *( 3.250e-2 - 4.138e-6 * Pt_QCDele1 ))"

    Region3 = "( (Pt_QCDele1 < 121.6) *(8.703e-2 - 2.213e-4  * Pt_QCDele1 ))+"
    Region3 = Region3 + "( (Pt_QCDele1>= 121.6) *( 5.527e-2 + 3.982e-5  * Pt_QCDele1 ))"

    FakeRateValue = "*("
    FakeRateValue = FakeRateValue + "( (abs(Eta_QCDele1)< 1.442) *(pow("+Region1+",2)))+"
    FakeRateValue = FakeRateValue + "( (abs(Eta_QCDele1)> 1.56) *(abs(Eta_QCDele1)< 2.0) *(pow("+Region2+",2)))+"
    FakeRateValue = FakeRateValue + "( (abs(Eta_QCDele1)> 1.56) *(pow("+Region3+",2)))"
