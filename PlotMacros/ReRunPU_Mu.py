...
submitter.write('cp *.txt '+here+'/MuPUReRun\n')
submitter.close()
...
submitter.write('cp '+here +'/Selection_mumu_NewQCDStudy_125jetptcut.csv .\n')
submitter.write('cp '+here +'/MakePlotsSingle_mumu2012_NonEmulatedTriggers.py .\n')
String = "python MakePlotsSingle_mumu2012_NonEmulatedTriggers.py -I -i Selection_mumu_NewQCDStudy_125jetptcut.csv -pu -f PUUpValues"+Name+'\n'
submitter.write(String)
submitter.write('cp *.txt '+here+'/MuPUReRun\n')
submitter.close()
