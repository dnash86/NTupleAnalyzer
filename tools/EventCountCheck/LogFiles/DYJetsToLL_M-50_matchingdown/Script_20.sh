...
File=/store/group/phys_exotica/leptonsPlusJets/RootNtuple/eberry/RootNtuple-V00-03-11-Summer12MC_DYJetsToLL_Systematics_MG_20130226_011151/DYJetsToLL_M-50_matchingdown_8TeV-madgraph__Summer12_DR53X-PU_S10_START53_V7A-v1__AODSIM_28_1_rCz.root
...
cat number.txt
cp number.txt /afs/cern.ch/user/d/dnash/CMSSW_5_0_0/src/NTupleAnalyzer/tools/EventCountCheck/LogFiles/DYJetsToLL_M-50_matchingdown/Log_20.txt
