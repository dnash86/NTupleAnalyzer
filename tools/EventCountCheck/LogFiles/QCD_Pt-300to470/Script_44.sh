...
File=/store/group/phys_exotica/leptonsPlusJets/RootNtuple/hsaka/RootNtuple-V00-03-11-Summer12MC_QCD_MuEnriched_PYTHIA_20130215_205103/QCD_Pt-300to470_MuEnrichedPt5_TuneZ2star_8TeV_pythia6__Summer12_DR53X-PU_S10_START53_V7A-v1__AODSIM_13_1_DLd.root
...
cp number.txt /afs/cern.ch/user/d/dnash/CMSSW_5_0_0/src/NTupleAnalyzer/tools/EventCountCheck/LogFiles/QCD_Pt-300to470/Log_44.txt
